...
$header .= "From: Новая заявка <mysnikbogdan3@gmail.com>\n\n";	
$mail = mail("mysnikbogdan3@gmail.com", $subject1, iconv ('utf-8', 'windows-1251', $message1), iconv ('utf-8', 'windows-1251', $header));
